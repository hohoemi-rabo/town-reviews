...
- `places` - Location information (4,670 facilities pre-registered from Google Places API)
...
- ✅ **Ticket 016**: Facility database pre-registration & search function ✅ **FULLY COMPLETED**
  ...
  - **Phase 3**: Google Places API bulk import (4,670 facilities), CSV import/export ✅
    - Iida City: 1,126 facilities
    - Shimoina major towns: 2,418 facilities
    - Shimoina villages: 1,126 facilities
